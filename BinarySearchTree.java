    /** A Binary Search Tree (BST) supporting insert, search, size, and clear operations */
    public class BinarySearchTree<T extends Comparable<T>> implements SortedCollection<T> {
        ...
        /**
         * Helper method to check if a value is present in the BST
         * @param find the value to search for in the BST
         * @param rootNode the current node in the BST being examined
         * @return true if the BST contains the specified value, false otherwise
         */
        private boolean containsHelper(Comparable<T> find, BinaryNode<T> rootNode) {
            if (rootNode == null) {
                return false;
            }
            if (find.compareTo(rootNode.getData()) == 0) {
                return true;
            } else if (find.compareTo(rootNode.getData()) < 0) {
                return containsHelper(find, rootNode.getLeft());
            } else {
                return containsHelper(find, rootNode.getRight());
            }
        }
        ...
        // Test 1: Check if BST correctly contains inserted integer
        ...
        // Test 2: Check if BST correctly contains inserted strings (with duplicates)
        ...
        // Test 3: Check BST size, clear, insert and contains
